...
for step in directions:
	...
	turtle.forward(int(step.strip("R").strip("L")))
	
end_coord = turtle.pos()

turtle.exitonclick()

distance = abs(int(round(end_coord[0]))) + abs(int(round(end_coord[1])))

print("You're %d steps away." % distance)